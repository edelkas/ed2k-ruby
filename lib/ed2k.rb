# This module encapsulates the contents of the entire gem. Most functionality is defined within more specific classes (see
# {Core}, {Server}, {Client} or {Packet}) or modules (see {Tag}, {Hashing} or {Obfuscation}).
#
